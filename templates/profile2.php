...
<head>
    ...
    <link rel="stylesheet" href="templates/assets/font-awesome/4.5.0/css/font-awesome.min.css" />

    <!-- page specific plugin styles -->
    <link rel="stylesheet" href="templates/assets/css/jquery-ui.custom.min.css" />
    <link rel="stylesheet" href="templates/assets/css/jquery.gritter.min.css" />
    ...
    <link rel="stylesheet" href="templates/assets/css/bootstrap-editable.min.css" />

    <!-- text fonts -->
    <link rel="stylesheet" href="templates/assets/css/fonts.googleapis.com.css" />

    <!-- ace styles -->
    <link rel="stylesheet" href="templates/assets/css/ace.min.css" class="ace-main-stylesheet" id="main-ace-style" />

    <!--[if lte IE 9]>
    <link rel="stylesheet" href="templates/assets/css/ace-part2.min.css" class="ace-main-stylesheet" />
    <![endif]-->
    <link rel="stylesheet" href="templates/assets/css/ace-skins.min.css" />
    <link rel="stylesheet" href="templates/assets/css/ace-rtl.min.css" />

    <!--[if lte IE 9]>
    <link rel="stylesheet" href="templates/assets/css/ace-ie.min.css" />
    <![endif]-->

    <!-- inline styles related to this page -->

    <!-- ace settings handler -->
    <script src="templates/assets/js/ace-extra.min.js"></script>

    <!-- HTML5shiv and Respond.js for IE8 to support HTML5 elements and media queries -->

    <!--[if lte IE 8]>
    <script src="templates/assets/js/html5shiv.min.js"></script>
            ...
            <ul class="nav ace-nav">
                    ...
                    <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                        ...
                        <li class="dropdown-content">
                            <ul class="dropdown-menu dropdown-navbar">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="templates/templates/assets/images/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
                                        <span class="msg-body">
													<span class="msg-title">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="templates/templates/assets/images/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
                                        <span class="msg-body">
													<span class="msg-title">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="templates/templates/assets/images/avatars/avatar2.png" class="msg-photo" alt="Kate's Avatar" />
                                        <span class="msg-body">
													<span class="msg-title">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="templates/templates/assets/images/avatars/avatar5.png" class="msg-photo" alt="Fred's Avatar" />
                                        <span class="msg-body">
													<span class="msg-title">
                ...
                <li class="light-blue dropdown-modal">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <img class="nav-user-photo" src="templates/templates/assets/images/avatars/user.jpg" alt="Jason's Photo" />
                                ...
                                <div class="col-xs-12 col-sm-3 center">
                                    <div>
												<span class="profile-picture">
													<img id="avatar" class="editable img-responsive" alt="Alex's Avatar" src="templates/templates/assets/images/avatars/profile-pic.jpg" />
												</span>
...
<!--[if IE]>
<script src="templates/assets/js/jquery-1.11.3.min.js"></script>
<![endif]-->
<script type="text/javascript">
    if('ontouchstart' in document.documentElement) document.write("<script src='templates/assets/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
</script>
...
<!--[if lte IE 8]>
<script src="templates/assets/js/excanvas.min.js"></script>
<![endif]-->
<script src="templates/assets/js/jquery-ui.custom.min.js"></script>
<script src="templates/assets/js/jquery.ui.touch-punch.min.js"></script>
<script src="templates/assets/js/jquery.gritter.min.js"></script>
<script src="templates/assets/js/bootbox.js"></script>
<script src="templates/assets/js/jquery.easypiechart.min.js"></script>
<script src="templates/assets/js/bootstrap-datepicker.min.js"></script>
<script src="templates/assets/js/jquery.hotkeys.index.min.js"></script>
<script src="templates/assets/js/bootstrap-wysiwyg.min.js"></script>
<script src="templates/assets/js/select2.min.js"></script>
<script src="templates/assets/js/spinbox.min.js"></script>
<script src="templates/assets/js/bootstrap-editable.min.js"></script>
<script src="templates/assets/js/ace-editable.min.js"></script>
